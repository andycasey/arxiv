...
\change{There were 234 pre-prints posted to the \texttt{q-bio} primary category in 2020 which include pandemic-related terms, and where the lead author had never before appeared on the \texttt{q-bio} pre-print before. We investigated every pre-print to extract the affiliation of those authors, and used this information to search the internet for the author's website. From this information we identified their research specialisations using their own words, or from their social media pages if no website could be found. In situations where an author's specialisation crossed multiple fields (e.g., mathematics and biology) we took a conservative approach and described the author as a biologist. However, we found that only 3\% (8/234) were led by established biologists who had not appeared in \texttt{q-bio} pre-prints before. About half (45\%; 107/234) were written by mathematicians or physicists, with another 26\% (61/234) led by engineers, computer scientists, or economists.}
